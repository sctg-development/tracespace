...
> Analytics tracking source code for @sctg/tracespace-view
...
The application state architecture of @sctg/tracespace-view is highly similar to [redux][], where there is a predefined set of actions that may be applied to a central store to transform the application state.
