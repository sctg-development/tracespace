# @sctg/gerber-to-svg API

Create a @sctg/gerber-to-svg converter like:
...
| key           | value    | default                                                                     |
| ------------- | -------- | --------------------------------------------------------------------------- |
| id            | String   | [`@sctg/tracespace-xml-id::random()`](../xml-id#randomlength-number-string) |
| attributes    | Object   | {}                                                                          |
...
If left unspecified, `options.id` will be a random 12 character string generated by [`@sctg/tracespace-xml-id`](../xml-id).
...
For more information, please reference the API documentation of [@sctg/gerber-parser](../@sctg/gerber-parser) and [@sctg/gerber-plotter](../@sctg/gerber-plotter), as these options are passed directly to these modules.
...
var cloneConverter = require('@sctg/gerber-to-svg/clone')
...
- `converter` is the original @sctg/gerber-to-svg converter or a clone of it
...
// or, for smaller builds
var renderConverter = require('@sctg/gerber-to-svg/render')
...
| property | type                           |
| -------- | ------------------------------ |
| parser   | `@sctg/gerber-parser` parser   |
| plotter  | `@sctg/gerber-plotter` plotter |
| defs     | Array                          |
| layer    | Array                          |
| viewBox  | Array                          |
| width    | String                         |
...
The parser and plotter properties are both transform streams used in the conversion process. If you need to hook into these streams, this is the place to do it. See [@sctg/gerber-parser](https://github.com/mcous/@sctg/gerber-parser) and [@sctg/gerber-plotter](https://github.com/mcous/@sctg/gerber-plotter) for more information and the APIs of these streams.
