...
| options    | `object`                                              | Optional [@sctg/gerber-to-svg options][4]                                                      |
| converter  | [`@sctg/gerber-to-svg converter`][6]                  | **Finished** [@sctg/gerber-to-svg][4] converter stream. Required if `layer.gerber` is not used |
| externalId | `string`                                              | Optional. See [pcb-stackup-core docs][8] for usage                                             |

If both `layer.converter` and `layer.gerber` are specified, `layer.converter` will take precedence and the layer will **not** be re-rendered by @sctg/gerber-to-svg.
...
| -------------- | --------- | ------------------------------ | ----------------------------------------------------------------------- |
| id             | `string`  | `xid.random()`                 | Unique identifier, generated by [@sctg/tracespace-xml-id][7] by default |
...
[4]: ../@sctg/gerber-to-svg/API.md#options
[5]: ../pcb-stackup-core/README.md#usage
[6]: ../@sctg/gerber-to-svg/API.md#streaming-api
[7]: ../xml-id
